...
│   ├── models.py        # SQLAlchemy 模型(含 users / sessions / requirements / activity_events / login_events)
...
└── frontend/            # React SPA
    └── src/
        ...
        ├── components/  # AppLayout(横贯顶栏 + 侧栏)/ CategoryManageModal / PhilosophyHero /
...
+ 第四版的**需求 / 动态**两张表 + 第五版的**登录审计**一张表与**评论 / 点赞**两张表:
